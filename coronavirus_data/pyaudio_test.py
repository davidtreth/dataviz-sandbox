    ...
    for area in sorted(cases_by_area):
        ...
        for i, n in enumerate(zip(datelist, ncases_valslist)):
            ...
            if i > 0 and ncases_valslist[i-1]>0:
                ...
                elif abs((ncases_valslist[i]-ncases_valslist[i-1])/ncases_valslist[i-1]) < 0.1:
...
if __name__ == '__main__':
    ...
    play_audio(cases_by_area, "", 2, 5, 0.5, args.short, 2, args.textonly)
    ...
    for c in ["Scotland", "Wales"]:
        ...
        play_audio(cases_by_area, "", 3, 4, 0.5, args.short, 2, args.textonly)
